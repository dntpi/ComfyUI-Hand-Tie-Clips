...
TASK 3 4b shipped on `llm-plan-writer` (`b81504e`). 4a (warm/evict vs OOM) is
still a measurement. TASK 4 merge is the live work: `soundtrack` → `main` →
`llm-plan-writer` → `texture-ratchet`. Do not re-render 2.6.
